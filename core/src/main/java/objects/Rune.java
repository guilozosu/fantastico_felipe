...
// Se definen dos constantes de tipo float que representan el ancho y alto de la moneda.
    private static final float RUNE_WIDTH = 16;
    private static final float RUNE_HEIGHT = 16;
...
// Se definen algunas variables para almacenar la textura de la moneda, la animación de su movimiento, la capa en la que está y el tiempo.
    ...
    public Rune() {
        ...
        coinTexture = new Texture("rune.png");
        ...
        setHeight(RUNE_HEIGHT / RUNE_WIDTH);

        // Se divide la textura de la moneda en un conjunto de regiones de textura del tamaño definido por las constantes RUNE_WIDTH y RUNE_HEIGHT.
        TextureRegion[][] grid = TextureRegion.split(coinTexture, (int) RUNE_WIDTH, (int) RUNE_HEIGHT);
        ...
        movement = new Animation<>(0.15f, grid[0][0], grid[0][1], grid[0][2], grid[0][3]);
