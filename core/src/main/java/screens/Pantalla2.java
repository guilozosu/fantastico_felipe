...
import characters.DinoAttack;
import characters.Dino;
...
public class Pantalla2 implements Screen {
    ...
    Dino dino1, dino2, dino3, dino4;
    DinoAttack dinoAttack1;
    ...
    boolean gotDino1 = false, gotDino2 = false, gotDino3 = false, gotDino4 = false;
    boolean gotDinoAttack1 = false;
    ...
    public void show() {
        ...
        gotDino1 = false; gotDino2 = false; gotDino3 = false; gotDino4 = false;
        gotDinoAttack1 = false;
        ...
        rune1.setPosition(140, 2);
        stage.addActor(rune1);
        
        // PERSONAJE principal
        koala = new Felipe();
        koala.layer = (TiledMapTileLayer) map.getLayers().get("walls");
        koala.setPosition(15, 10);
        stage.addActor(koala);
        
        // DINO
        dino1 = new Dino();
        dino1.layer = (TiledMapTileLayer) map.getLayers().get("walls");
        dino1.setPosition(5, 2);
        stage.addActor(dino1);
        
        dino2 = new Dino();
        dino2.layer = (TiledMapTileLayer) map.getLayers().get("walls");
        dino2.setPosition(45, 2);
        stage.addActor(dino2);
        
        dino3 = new Dino();
        dino3.layer = (TiledMapTileLayer) map.getLayers().get("walls");
        dino3.setPosition(30, 2);
        stage.addActor(dino3);
        
        dino4 = new Dino();
        dino4.layer = (TiledMapTileLayer) map.getLayers().get("walls");
        dino4.setPosition(110, 2);
        stage.addActor(dino4);
        
        // DINOATTACK
        dinoAttack1 = new DinoAttack();
        dinoAttack1.layer = (TiledMapTileLayer) map.getLayers().get("walls");
        dinoAttack1.setPosition(35, 7);
        stage.addActor(dinoAttack1);
        
        // MONSTRUOS
//        monster1 = new Monster();
//        monster1.layer = (TiledMapTileLayer) map.getLayers().get("walls");
//        monster1.setPosition(130, 2);
//        stage.addActor(monster1);
        
        monster2 = new Monster();
        monster2.layer = (TiledMapTileLayer) map.getLayers().get("walls");
        monster2.setPosition(157, 2);
        stage.addActor(monster2);
        
        monster3 = new Monster();
        monster3.layer = (TiledMapTileLayer) map.getLayers().get("walls");
        monster3.setPosition(170, 2);
        stage.addActor(monster3);
        
        monster4 = new Monster();
        monster4.layer = (TiledMapTileLayer) map.getLayers().get("walls");
        monster4.setPosition(178, 2);
    ...
    public void render(float delta) {
        ...
        */
        ...
        if (koala.dimension().overlaps(dinoAttack1.dimension()) && gotDinoAttack1 == false) {
            if(juego.isSonidoOn() == true)
                hurtSound.play();
            dinoAttack1.remove();
            gotDinoAttack1 = true;
        ...
        if (koala.dimension().overlaps(dino1.dimension()) && gotDino1 == false) {
            if(juego.isSonidoOn() == true)
                hurtSound.play();
            dino1.remove();
            gotDino1 = true;
        ...
        if (koala.dimension().overlaps(dino2.dimension()) && gotDino2 == false) {
            if(juego.isSonidoOn() == true)
                hurtSound.play();
            dino2.remove();
            gotDino2 = true;
        ...
        if (koala.dimension().overlaps(dino3.dimension()) && gotDino3 == false) {
            if(juego.isSonidoOn() == true)
                hurtSound.play();
            dino3.remove();
            gotDino3 = true;
        ...
        if (koala.dimension().overlaps(dino4.dimension()) && gotDino4 == false) {
            if(juego.isSonidoOn() == true)
                hurtSound.play();
            dino4.remove();
            gotDino4 = true;
...
//        }
        ...
        level.draw(batch, "Nivel: 2", 30, 400);
        batch.end();
    }
